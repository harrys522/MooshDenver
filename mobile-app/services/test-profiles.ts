...
export const profiles: Profile[] = [
    {
        ...
        properties: [
            { type: propertyTypes.findIndex((p) => p.name === "Sex"), is: getPropertyIndex("Sex", "heterosexual"), prefered: [], notPrefered: [], mustHave: [], cantHave: [] },
    ...
    },
    {
        ...
        exclusionList: [[32]],
        properties: [
            { type: propertyTypes.findIndex((p) => p.name === "Sex"), is: getPropertyIndex("Sex", "homosexual"), prefered: [], notPrefered: [], mustHave: [], cantHave: [] },
    ...
    },
    {
        ...
        exclusionList: [[32]],
        properties: [
            { type: propertyTypes.findIndex((p) => p.name === "Sex"), is: getPropertyIndex("Sex", "bisexual"), prefered: [], notPrefered: [], mustHave: [], cantHave: [] },
